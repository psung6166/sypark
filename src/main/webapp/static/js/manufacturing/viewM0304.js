/**
 *  comment : viewM0304.jsp 에 해당하는 js 파일입니다.
 *  date : 2022. 03. 22
 *  auth : psy	
 */
...
function fnChangeTeam(){
	...
	var select_team = $("#select_team").val();
	
	var param = {"select_team":select_team};
	...
	$.ajax({
		...
		success: function(response) {
			...
			$("#M0304_table").dataTable({
				...
				columns: [
					{
						data: "FEATURE", sClass:"text-center"
					},
					{
						data: function(data){
							if(data.TEAM == "1"){
					...
					{ 
						data: function(data){
							return "<div class='text-end' style='color:red;'>"+data.UP_99+"</div>";
						} 
					},
				],
				scrollX:true,
