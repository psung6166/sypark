/**
 *  comment : viewM0301.jsp 에 해당하는 js 파일입니다.
 *  date : 2022. 03. 18
 *  auth : psy	
 */
...
$(function() {
	...
	//selectViewEfficientRank();
	
	$("#M0301_table").DataTable({
		responsive: true,
		scrollX:true,
		sScrollXInner: "100%",
		autoWidth: true,
...
function selectViewEfficientRank() {

	var param = "";

	$.ajax({
		type: 'GET',
		url: '/manufacturing/selectViewEfficientRank.do',
		dataType: 'json',
		async: false,
		data: param,
		success: function(response) {
			var data = response.resultList;
			var table = $('#M0301_table');
			var thead = $('#M0301_table_thead');
			var tbody = $('#M0301_table_tbody');
			var tfoot = $("#M0301_table_tfoot");
